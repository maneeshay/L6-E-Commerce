            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        <tr>
                            <td class="align-middle"><img src="{{asset($cart->book_image)}}" alt="" style="width: 50px;">{{$cart->book_name}}</td>
                            <td class="align-middle">{{$cart->book_price}}</td>
                            ...
                            <td class="align-middle"><button class="btn btn-sm btn-primary"><a href="{{ url('cart/delete/'.$cart->id) }}"><i class="fa fa-times"></i></a></button></td>
                        </tr>  
                    </tbody>
                    @endforeach
                </table>
